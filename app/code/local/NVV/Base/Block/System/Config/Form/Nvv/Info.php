...
* 
*/
class NVV_Base_Block_System_Config_Form_Nvv_Info extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    protected function _getFooterHtml($element)
    {
        ...
        ");
        $html = '<h4>' . $this->__('Installed NVV Extensions') . '</h4>' . $html;
