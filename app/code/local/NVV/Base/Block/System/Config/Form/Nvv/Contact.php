...
* 
*/
class NVV_Base_Block_System_Config_Form_Nvv_Contact extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        $html = $this->_getHeaderHtml($element);
       	$formElements=array(
            ...
            array('type' => 'label', 'name' => 'send', 'after_element_html' => '<div class="right"><button type="button" class="scalable save" onclick="nvvSupport();">'.$this->__('Send').'</button></div><div class="notice" id="ajax-response"></div>'),
       		);
    ...
    protected function _getFooterHtml($element)
    {
        ...
        ");
        $html = '<h4 id="nvvcontact">'.$this->__('Contact NVV Support Team ').'</h4>' . $html;
        $html .= Mage::helper('adminhtml/js')->getScript("
